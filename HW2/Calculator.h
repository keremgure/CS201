...
class Calculator {
public:
    explicit Calculator(string); // constructor that takes an arithmetic expression in infix representation
	~Calculator(); // destructor
	string getPostfix(); // returns the postfix representation of the arithmetic expression
	int calculate();
	// evaluates and returns the result of the arithmetic expression
private:
